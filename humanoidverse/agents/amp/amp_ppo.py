...
class AMPPPO(PPO):
    ...
    def _init_loss_dict_at_training_step(self):
        ...
        loss_dict['Discriminator_Loss'] = 0
        loss_dict['Discriminator_Real_Acc'] = 0
        loss_dict['Discriminator_Fake_Acc'] = 0
        loss_dict['Discriminator_Total_Acc'] = 0
        loss_dict['AMP_Reward_Mean'] = 0
        return loss_dict
