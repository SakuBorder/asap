...
class MotionLibBase():
    def __init__(self, motion_lib_cfg, num_envs, device):
        ...
        self.isaac_gym_joint_mapping = self.m_cfg.isaac_gym_joint_mapping
        self.use_joint_mapping = self.m_cfg.use_joint_mapping
        self.sign_flip_set = self.m_cfg.sign_flip_set
        return
